...
public class GuiConditionalButtonComponent<GuiData> implements GuiComponent<GuiData, Void> {
    ...
    public GuiConditionalButtonComponent(Map<String, ItemStack> items, GuiButtonConfig config, BiPredicate<GuiInstance<GuiData>, Player> shouldRender, BiConsumer<InventoryClickEvent, GuiInstance<GuiData>> handler) {
